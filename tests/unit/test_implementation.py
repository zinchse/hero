...
def test_convolution_implementation(
    batch_vertices: "Tensor", batch_edges: "Tensor", convolved_vertices: "Tensor", conv1d: "torch.nn.Conv1d"
):
...
def test_activation_implementation(batch_vertices: "Tensor", batch_edges: "Tensor", activated_vertices: "Tensor"):
    binary_tree_activation = BinaryTreeActivation(activation=torch.nn.functional.relu)
    with torch.no_grad():
...
def test_pooling_implementation(batch_vertices: "Tensor", batch_edges: "Tensor", pooled_vertices: "Tensor"):
    binary_tree_adaptive_pooling = BinaryTreeAdaptivePooling(adaptive_pool=torch.nn.AdaptiveMaxPool1d(1))
    with torch.no_grad():
...
def test_full_block_implementation(
    batch_vertices: "Tensor", batch_edges: "Tensor", full_block_processed_vertices: "Tensor", conv1d: "torch.nn.Conv1d"
):
    block = BinaryTreeSequential(
        BinaryTreeConv(in_channels=2, out_channels=1),
        BinaryTreeLayerNorm(in_channels=1, eps=0),
        BinaryTreeActivation(activation=torch.nn.functional.relu),
        BinaryTreeAdaptivePooling(adaptive_pool=torch.nn.AdaptiveMaxPool1d(1)),
    )
