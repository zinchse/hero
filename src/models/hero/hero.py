...
time of the greedy (which suffuers because of the need for sequential planning calls)
"""

from typing import Tuple, Optional, List
from functools import lru_cache
from src.models.predictor import Predictor
from src.datasets.data_types import Parameter, Time, QueryName, HintsetCode, QueryDop
from src.datasets.data_config import DEFAULT_DOP, DEFAULT_HINTSET
from src.models.hero.local_search_settings import SearchingSettings
from src.models.hero.query_explorer import QueryExplorer
from src.models.hero.storage import Storage, Node, Transition
...
class Hero(Predictor):
    ...
    def explore(self, query_name: "QueryName") -> "Time":
        explorer = QueryExplorer(query_name, self.fit_settings, self.execution_model)
        hs, dop = explorer.run()
